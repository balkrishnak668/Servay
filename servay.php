        ...
        <form method="post" action="dbservay.php" id="survey-form">
            ...
            <div class="form-group">
                ...
                <select name="spices"  id="dropdown" class="formControl">
                    ...
                    <option value="Adrak Powder- अदरक मसाला - Dry Ginger Powder">Adrak Powder- अदरक मसाला - Dry Ginger Powder</option>
                    <option value="Amchur - अमचूर - Dry mango powder">Amchur - अमचूर - Dry mango powder</option>
                    <option value="cumin seeds (jeera )">cumin seeds (jeera )</option>
                    <option value="Tejpatta Powder- तेज़ पत्ता मसाला - Bay Leaf powder">Tejpatta Powder- तेज़ पत्ता मसाला - Bay Leaf powder</option>
            ...
            <div class="form-group">
                ...
                <select name="dryfruits" class="formControl">
                    ...
                    <option value="Nariyal - नारियल - dry coconut">Nariyal - नारियल - dry coconut</option>
                    <option value="Akhrot - अखरोट - Walnut">Akhrot - अखरोट - Walnut</option>
                    <option value="Badam">Badam</option>
                    <option value="Pista - पिस्ता - Pistachio">Pista - पिस्ता - Pistachio</option>
                    <option value="छुहारा - Chhuhara - Dry Date">छुहारा - Chhuhara - Dry Date</option>
                    <option value="Khajoor - खजूर - Date">Khajoor - खजूर - Date</option>
                    <option value="All of them">All of them</option>
                </select>
            </div>
